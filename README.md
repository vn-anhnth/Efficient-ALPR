...
<p align="center">
  ...
  <br>
  <em>Visual samples of challenging real-world license plates (motion blur, diverse layouts, low light) that Efficient-ALPR is built to handle.</em>
</p>
...
Efficient-ALPR provides a complete suite of scripts in the `tools/` directory for dataset preparation, training, evaluation, and inference.
...
- **OpenOCR**: Efficient-ALPR is built upon the robust foundation of [OpenOCR](https://github.com/Topdu/OpenOCR).
